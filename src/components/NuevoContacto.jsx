...
const NuevoContacto = () => {
    ...
    const confirmaPeticion = (editando) => {
        if (
            !nombres ||
            !apellidos ||
            !email ||
    ...
    return (
        <div className=" px-8 w-full flex flex-col items-center align-center ">
            <div className='w-full mt-8'>
                {error ? <p className=' bg-red-500 text-white p-5 rounded-2xl'> Todos los campos son requeridos </p> : null}
                ...
                <form className="bg-fondo shadow rounded-3xl p-4">
                    ...
                    >
                        ...
                        <option value="cliente">Landin Page</option>
